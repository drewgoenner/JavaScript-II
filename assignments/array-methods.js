...
runners.forEach(getFull => {
    fullName.push(`${getFull.first_name}, ${getFull.last_name}`)
})
...
let ticketPriceTotal = runners.reduce(function(accumulator, charity) {
    return accumulator + charity.donation;
}, 0)
